                        ...
                        <div class="col-lg-5 mx-auto">
                            <div class="card bg-color">
                                <div class="card-body p-0 auth-header-box">
                                    <div class="text-center p-3">
                                        <a href="index.html" class="logo logo-admin">
                                            <img src="{{ url('assets/images/crimson-logo.png') }}" height="50" alt="logo" class="auth-logo">
                                        </a>
                                        <h4 class="mt-3 mb-1 fw-semibold text-muted font-18">Let's Get Started Crimson Logistics</h4>   
                                        <p class="text-muted  mb-0">Sign in to continue to Crimson Logistics.</p>  
                                    </div>
                                </div>
                                        ...
                                        <div class="tab-pane active p-3" id="LogIn_Tab" role="tabpanel">                                        
                                            <form method="POST" action="{{ route('login') }}">
                                                ...
                                                <div class="form-group mb-0 row">
                                                    <div class="col-12">
                                                        <button class="btn btn-primary bg-info w-100 waves-effect waves-light" type="submit">Log In <i class="fas fa-sign-in-alt ms-1"></i></button>
                                                    </div><!--end col--> 
                                                </div> <!--end form-group-->                           
                                            </form><!--end form-->
                                ...
                                <div class="card-body bg-light-alt text-center">
                                    <span class="text-muted d-none d-sm-inline-block">Crimson Logistics © <script>
